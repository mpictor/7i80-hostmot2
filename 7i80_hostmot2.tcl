# 
# Project automation script for hostmot2 
# 
# Created for ISE version 14.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source hostmot2.tcl), then you can
...
set myProject "hostmot2"
set myScript "hostmot2.tcl"
...
proc add_source_files {} {
   ...
   xfile add "7i80db.ucf"
   xfile add "CountPinsInRange.vhd"
   xfile add "IDROMConst.vhd"
   xfile add "MaxIOPinsPerModule.vhd"
   xfile add "MaxInputPinsPerModule.vhd"
   xfile add "MaxOutputPinsPerModule.vhd"
   xfile add "MaxPinsPerModule.vhd"
   xfile add "ModuleExists.vhd"
   xfile add "NumberOfModules.vhd"
   xfile add "OutputInteg.vhd"
   xfile add "PIN_24XQCTRONLY_72.vhd"
   xfile add "PIN_2X7I65_72.vhd"
   xfile add "PIN_3x7I65_1x7I44_96.vhd"
   xfile add "PIN_4x7I65_96.vhd"
   xfile add "PIN_7I74x2_34.vhd"
   xfile add "PIN_7I74x4_68.vhd"
   xfile add "PIN_7I76_34.vhd"
   xfile add "PIN_7I76_7I74_34.vhd"
   xfile add "PIN_7I76_7I78_34.vhd"
   xfile add "PIN_7I76x2_34.vhd"
   xfile add "PIN_7I76x2_7I74x2_68.vhd"
   xfile add "PIN_7I76x3_68.vhd"
   xfile add "PIN_7I76x3_7I74_68.vhd"
   xfile add "PIN_7I77E_51.vhd"
   xfile add "PIN_7I77_7I74_34.vhd"
   xfile add "PIN_7I77_7I76_34.vhd"
   xfile add "PIN_7I77x2_34.vhd"
   xfile add "PIN_7I77x2_7I74x2_68.vhd"
   xfile add "PIN_7I77x4_68.vhd"
   xfile add "PIN_7I78_34.vhd"
   xfile add "PIN_7I78x2_34.vhd"
   xfile add "PIN_7I85x2_34.vhd"
   xfile add "PIN_Andy1_72.vhd"
   xfile add "PIN_BISSTEST_34.vhd"
   xfile add "PIN_BOSSV.vhd"
   xfile add "PIN_DA2_72.vhd"
   xfile add "PIN_DA2_ADO_72.vhd"
   xfile add "PIN_FALLBACK_34.vhd"
   xfile add "PIN_G540x2_34.vhd"
   xfile add "PIN_IOONLY_34.vhd"
   xfile add "PIN_JUSTIO_68.vhd"
   xfile add "PIN_JUSTIO_72.vhd"
   xfile add "PIN_PROB_RFx2_34.vhd"
   xfile add "PIN_RMSVSS6_12_8_72.vhd"
   xfile add "PIN_RMSVSS6_6_8_72.vhd"
   xfile add "PIN_RMSVSS6_8_72.vhd"
   xfile add "PIN_RS12_96.vhd"
   xfile add "PIN_RSST12_8_96.vhd"
   xfile add "PIN_SISVST6_2_3_7I47_48.vhd"
   xfile add "PIN_SPSVST_7I47_7I65_48.vhd"
   xfile add "PIN_SSSV6_36_96.vhd"
   xfile add "PIN_SSSV8_48_96.vhd"
   xfile add "PIN_ST12_72.vhd"
   xfile add "PIN_ST16_72.vhd"
   xfile add "PIN_ST18_72.vhd"
   xfile add "PIN_ST20_72.vhd"
   xfile add "PIN_ST24_72.vhd"
   xfile add "PIN_ST48_96.vhd"
   xfile add "PIN_STSV6_1_34.vhd"
   xfile add "PIN_SV12IM_2X7I48_72.vhd"
   xfile add "PIN_SV12IM_2X7I49_72.vhd"
   xfile add "PIN_SV12_2X7I49_96.vhd"
   xfile add "PIN_SV12_3X7I47_72.vhd"
   xfile add "PIN_SV12_72.vhd"
   xfile add "PIN_SV16_96.vhd"
   xfile add "PIN_SV24_144.vhd"
   xfile add "PIN_SV6_7I49_72.vhd"
   xfile add "PIN_SV8NA.vhd"
   xfile add "PIN_SV8_48.vhd"
   xfile add "PIN_SVRM6_48.vhd"
   xfile add "PIN_SVSP4_6_7I46NA_48.vhd"
   xfile add "PIN_SVSP6_2_48.vhd"
   xfile add "PIN_SVSP8_6_7I46_72.vhd"
   xfile add "PIN_SVSPD6_2_48.vhd"
   xfile add "PIN_SVSS4_4_72.vhd"
   xfile add "PIN_SVSS4_8_48.vhd"
   xfile add "PIN_SVSS6_6_72.vhd"
   xfile add "PIN_SVSS6_8_72.vhd"
   xfile add "PIN_SVSS6_8_96.vhd"
   xfile add "PIN_SVSS8_16_96.vhd"
   xfile add "PIN_SVSS8_8_72.vhd"
   xfile add "PIN_SVST12_12_2X7I48_2X7I47_96.vhd"
   xfile add "PIN_SVST12_12_2X7I48_96.vhd"
   xfile add "PIN_SVST16_24_144.vhd"
   xfile add "PIN_SVST2_4_7I47_48.vhd"
   xfile add "PIN_SVST2_4_7I47_72.vhd"
   xfile add "PIN_SVST2_8_72.vhd"
   xfile add "PIN_SVST2_8_GREG_72.vhd"
   xfile add "PIN_SVST4_12NA_48.vhd"
   xfile add "PIN_SVST4_12_48.vhd"
   xfile add "PIN_SVST4_4IM2SI_72.vhd"
   xfile add "PIN_SVST4_4NA_48.vhd"
   xfile add "PIN_SVST4_4_48.vhd"
   xfile add "PIN_SVST4_6NA_48.vhd"
   xfile add "PIN_SVST4_6_48.vhd"
   xfile add "PIN_SVST4_8_72.vhd"
   xfile add "PIN_SVST4_8_ADO_72.vhd"
   xfile add "PIN_SVST6_6_7I48_48.vhd"
   xfile add "PIN_SVST6_6_7I48_72.vhd"
   xfile add "PIN_SVST6_6_7I52S_48.vhd"
   xfile add "PIN_SVST6_6_7I52S_72.vhd"
   xfile add "PIN_SVST8_12_2x7I47_72.vhd"
   xfile add "PIN_SVST8_24_96.vhd"
   xfile add "PIN_SVST8_3P_72.vhd"
   xfile add "PIN_SVST8_4IM2SI_72.vhd"
   xfile add "PIN_SVST8_4IM2_72.vhd"
   xfile add "PIN_SVST8_4P_72.vhd"
   xfile add "PIN_SVST8_4_72.vhd"
   xfile add "PIN_SVST8_8IM2_72.vhd"
   xfile add "PIN_SVST8_8_96.vhd"
   xfile add "PIN_SVSTSP8_12_6_96.vhd"
   xfile add "PIN_SVSTTP6_6_7I39_72.vhd"
   xfile add "PIN_SVSTUA6_6_6_7I48_72.vhd"
   xfile add "PIN_SVSTUA6_6_8_7I48_72.vhd"
   xfile add "PIN_SVTP4_7I39_48.vhd"
   xfile add "PIN_SVTW4_1_10_72.vhd"
   xfile add "PIN_SVTW4_24_24_48.vhd"
   xfile add "PIN_SVTW8_24_24_72.vhd"
   xfile add "PIN_SVUA4_8_48.vhd"
   xfile add "PIN_SVUA8_4_72.vhd"
   xfile add "PIN_SVUA8_8_72.vhd"
   xfile add "PIN_SVWG8_2IM2_72.vhd"
   xfile add "PIN_SVWG8_8IM2_72.vhd"
   xfile add "PIN_SYIL1_34.vhd"
   xfile add "PIN_TORMACH1_34.vhd"
   xfile add "PIN_UA2_34.vhd"
   xfile add "PinExists.vhd"
   xfile add "Sixi25_x9card.vhd"
   xfile add "TopEthernet16HostMot2.vhd"
   xfile add "adpram.vhd"
   xfile add "atrans.vhd"
   xfile add "b32qcondmac2w.vhd"
   xfile add "binosc.vhd"
   xfile add "biss.vhd"
   xfile add "boutreg.vhd"
   xfile add "bufferedspi.vhd"
   xfile add "d16w.vhd"
   xfile add "d8o8sq.vhd"
   xfile add "d8o8sqw.vhd"
   xfile add "daqfifo16.vhd"
   xfile add "decodedstrobe.vhd"
   xfile add "decodedstrobe2.vhd"
   xfile add "dpll.vhd"
   xfile add "dpram.vhd"
   xfile add "drqlogic.vhd"
   xfile add "etherhm2.vhd"
   xfile add "hostmot2.vhd"
   xfile add "hostmotid.vhd"
   xfile add "i20card.vhd"
   xfile add "i22_1000card.vhd"
   xfile add "i22_1500card.vhd"
   xfile add "i23card.vhd"
   xfile add "i25_x9card.vhd"
   xfile add "i43_200card.vhd"
   xfile add "i43_400card.vhd"
   xfile add "i61_x16card.vhd"
   xfile add "i61_x25card.vhd"
   xfile add "i65card.vhd"
   xfile add "i68card.vhd"
   xfile add "i69_x16card.vhd"
   xfile add "i77e_x9card.vhd"
   xfile add "i80db_x16card.vhd"
   xfile add "i80db_x25card.vhd"
   xfile add "i80esb_x9card.vhd"
   xfile add "idrom.vhd"
   xfile add "irqlogic.vhd"
   xfile add "kubstepgenz.vhd"
   xfile add "kubstepgenzi.vhd"
   xfile add "log2.vhd"
   xfile add "oneofndecode.vhd"
   xfile add "parity.vhd"
   xfile add "pwmpdmgenh.vhd"
   xfile add "pwmrefh.vhd"
   xfile add "qcounterate.vhd"
   xfile add "qcountersf.vhd"
   xfile add "qcountersfp.vhd"
   xfile add "resolver.vhd"
   xfile add "resolverdaq2.vhd"
   xfile add "resrom.vhd"
   xfile add "resroms.vhd"
   xfile add "simplespi8x.vhd"
   xfile add "simplespix.vhd"
   xfile add "simplessi.vhd"
   xfile add "sine16.vhd"
   xfile add "sserialw.vhd"
   xfile add "sslbpram.vhd"
   xfile add "sslbprom.vhd"
   xfile add "syncwavegen.vhd"
   xfile add "threephasepwm.vhd"
   xfile add "timestamp.vhd"
   xfile add "twiddle.vhd"
   xfile add "twidrom.vhd"
   xfile add "uartr.vhd"
   xfile add "uartr8.vhd"
   xfile add "uartx.vhd"
   xfile add "uartx8.vhd"
   xfile add "ubrategen.vhd"
   xfile add "usbram.vhd"
   xfile add "usbrom.vhd"
   xfile add "watchdog.vhd"
   xfile add "wavegen.vhd"
   xfile add "waveram.vhd"
   xfile add "wordpr.vhd"
   xfile add "wordrb.vhd"
   xfile add "x20_1000card.vhd"
   xfile add "x20_1500card.vhd"
   xfile add "x20_2000card.vhd"

   # Set the Top Module as well...
   project set top "Behavioral" "TopEthernetHostMot2"
...
proc set_process_props {} {
   ...
   project set "User Browsed Strategy Files" "C:/Xilinx/13.1/ISE_DS/ISE/data/default.xds"
   ...
   project set "Target UCF File Name" "C:/ISE14/hostmot2/TopPCITargetHostMot2.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Number of Paths in Error/Verbose Report" "10" -process "Generate Post-Place & Route Static Timing"
   ...
   project set "Work Directory" "C:/ISE14/hostmot2/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "TopEthernetHostMot2" -process "Generate IBIS Model"
